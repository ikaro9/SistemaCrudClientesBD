...
public class Menu {
    ...
    public void cadastrarCliente() {
      ...
      try {
          ...
          if(e.getMessage().contains("UNIQUE")){
              System.out.println("Já existe um cliente com estas informações.");
          }
          else{
    ...
    public void removerCliente(){
       try {
           ...
           if (cliente == null) {
               ...
               System.out.println("Tem certeza que deseja remover " + cliente.getNome() + " ? (S/N)");
               String conf;
               do {
           ...
           System.out.println("Erro ao remover cliente. Tente novamente mais tarde.");
       }
    }
    ...
    public void atualizarCliente(){
        try {
            ...
            if (cliente == null) {
                ...
                System.out.println("Deseja atualizar " + cliente.getNome() + " ? (S/N)");
                String conf;
                do {
                    conf = input.nextLine().trim();
                    if (conf.equalsIgnoreCase("s")) {
            ...
            if(e.getMessage().contains("UNIQUE")){
                System.out.println("Já existe um cliente com essas informações.");
            }
            else {
                System.out.println("Erro ao atualizar cliente. Tente novamente mais tarde." );
            }
        }
    }
    public void listaClientes(){
      try {
          ...
          System.out.println("Erro ao listar clientes. Tente novamente mais tarde.");
      }
    }
    public void buscarID(){
        try {
            ...
            System.out.println("Erro ao buscar cliente. Tente novamente mais tarde.");
        }
    }
    public void limparRegistros() {
        try {
            ...
            System.out.println("Erro ao limpar registros. Tente novamente mais tarde.");
        }
    }
}
